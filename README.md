...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| 0900&8209;0940 | Introduction to metabolic modelling                                                                                                                                            | Karthik Raman                                      |
| 0940-0950      | Short break                                                                                                                                                                    |                                                    |
| 0950-1040      | Overview of methods for metabolic modelling of microbiomes                                                                                                                     | Aarthi Ravikrishnan                                |
| 1040-1050      | Short break                                                                                                                                                                    |                                                    |
| 1050-1150      | Hands-on session: Using graph-based tools such as MetQuest to understand bacterial interactions in microbiomes, Simulating constraint-based models of microbial communities | Dinesh Kumar K B, Aarthi Ravikrishnan & Karthik Raman |
